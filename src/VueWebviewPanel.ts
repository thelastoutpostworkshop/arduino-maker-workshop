...
import { arduinoExtensionChannel, arduinoProject, checkArduinoCLICommand, getBoardConfiguration, getBoardConnected, getBoardsListAll, loadArduinoConfiguration, openExample } from "./extension";
import { addCLIConfigAdditionalBoardURL, createNewSketch, getCLIConfig, getCoreUpdate, getOutdatedBoardAndLib, removeCLIConfigAdditionalBoardURL, runInstallCoreVersion, runInstallLibraryVersion, runUninstallCoreVersion, runUninstallLibrary, searchCore, searchLibrary, searchLibraryInstalled, setCLIConfigAdditionalBoardURL } from "./cli";
